...
rem
rem Modified by Gavin Hurlbut for use to start a buildslave
...
d:
cd \buildbot\mythtv
rem start %WD%sh --login -i -c "cd /d/buildbot/mythtv && buildslave --verbose start"
start %WD%sh -c "buildslave --verbose start"
exit
